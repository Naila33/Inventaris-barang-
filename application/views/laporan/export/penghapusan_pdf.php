...
<body>
    <div class="header">
        <h1>LAPORAN PENGHAPUSAN BARANG</h1>
    ...
    <table>
        <thead>
            <tr>
                <th width="5%">No</th>
                <th width="15%">Tanggal Penghapusan</th>
                <th width="15%">Kode Barang</th>
                <th width="25%">Nama Barang</th>
                <th width="20%">Jenis Penghapusan</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center"><?= date('d/m/Y', strtotime($item['tanggal_penghapusan'])) ?></td>
